...
const TRUST_CARDS = [
  {
    ...
    description: "Все условия и ответственность прописаны",
  },
  {
    title: "Сдаём отчётность в срок",
    description: "Без штрафов и просрочек",
  },
  {
    title: "Всегда на связи",
    description: "Отвечаем в течение дня",
  },
  {
    title: "Понятный учёт",
    description: "Понимаете, за что платите",
  },
] as const
