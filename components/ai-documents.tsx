...
export function AIDocuments() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Автоматический разбор находит ошибки и подсказывает, что поправить'
    }
  ]
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-blue-200 w-full max-w-none md:max-w-4xl mx-auto">
            Система автоматически распознаёт, классифицирует и обрабатывает ваши документы,
            ускоряет учёт и снижает риск ошибок на рутинных операциях.
          </p>
          <Link 
            href="/ai-documents"
