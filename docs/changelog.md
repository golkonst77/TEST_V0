...
- **Система управления видимостью по устройствам**: Добавлена возможность отдельно настраивать видимость секций для мобильных и десктопных устройств
...
## [2024-12-19] - Восстановление системы управления секциями и исправление навигации
